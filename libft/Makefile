...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2022/04/22 20:36:15 by ansanche          #+#    #+#              #
#    Updated: 2022/04/25 21:06:31 by ansanche         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
AR = ar rcs
SRCS =  ft_bzero.c ft_isalpha.c ft_isdigit.c \
        ft_isalnum.c ft_strlen.c ft_isprint.c ft_isascii.c ft_memset.c \
